...
SECRET_KEY = '!@_(06)o$s*_=+i(6q6vye#vgl(sx(l43viq+-yo)s&=%v92#g'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'byuisgroup22@gmail.com'
EMAIL_HOST_PASSWORD = 'JuniorCore2014!'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
...
STATIC_ROOT = os.path.join(BASE_DIR, 'Store/media/images')
